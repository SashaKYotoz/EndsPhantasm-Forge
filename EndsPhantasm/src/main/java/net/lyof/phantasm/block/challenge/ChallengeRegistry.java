...
public class ChallengeRegistry {
    private static final Map<ResourceLocation, Challenge> REGISTRY = new HashMap<>();
    ...
    public static Challenge register(ResourceLocation id, Challenge data) {
        REGISTRY.putIfAbsent(id, data);
        return data;
    }

    public static Challenge get(ResourceLocation id) {
