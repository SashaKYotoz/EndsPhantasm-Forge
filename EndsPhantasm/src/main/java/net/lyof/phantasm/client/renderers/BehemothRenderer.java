...
public class BehemothRenderer extends MobRenderer<BehemothEntity, BehemothModel<BehemothEntity>> {
    private static final ResourceLocation TEXTURE = Phantasm.makeID( "textures/entity/behemoth/behemoth.png");
    private static final ResourceLocation TEXTURE_ANGRY = Phantasm.makeID( "textures/entity/behemoth/behemoth_angry.png");
